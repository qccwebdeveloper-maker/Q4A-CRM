      ...
      <aside className={`sidebar ${open ? 'open' : ''} ${sidebarCollapsed ? 'sidebar-collapsed' : ''} ${mini ? 'mini' : ''}`}>
        ...
        <div className="sidebar-top">
          <div className="logo-mark">
            <img src="/QC.png" alt="Q4A Management" style={{ width: '40px', height: '40px', objectFit: 'contain' }} />
          </div>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div className="logo-text-top">Q4A Management</div>
            <div className="logo-text-sub">Q4A CRM Platform</div>
          </div>
          {/* Mobile close button */}
