  ...
  return (
    <div>
      ...
      <div className="aud-g2">
        <Field label="REF NO."><Inp value={d.refNo} onChange={v => set('refNo', v)} placeholder="Q4A-2024-001" /></Field>
...
export function Step7({ d, set }) {
  return (
    <div>
      ...
      <div className="aud-g2">
        <Field label="Q4A Hereby Certifies That the" col="1/-1">
        ...
        <Field label="Certificate Number"><Inp value={d.certNumber} onChange={v => set('certNumber', v)} placeholder="Q4A-2024-001-ISO9001" /></Field>
      ...
      <div style={{ background: 'white', borderRadius: 12, maxWidth: 920, margin: '0 auto', padding: '24px', boxShadow: '0 20px 60px rgba(0,0,0,0.35)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20, flexWrap: 'wrap', gap: 10 }}>
          <div>
            ...
            <div style={{ fontSize: 11.5, color: '#64748b' }}>Q4A Management · Complete Audit Documentation</div>
          </div>
