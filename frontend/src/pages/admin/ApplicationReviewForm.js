      ...
      <div className="card" style={{ marginBottom: 18 }}>
        <div className="card-body" style={{ padding: 16 }}>
          ...
          <div style={{ margin: '16px 0 12px', padding: '12px 14px', background: '#fffbeb', border: '1px solid #fde68a', borderRadius: 8, fontSize: 12, color: 'var(--gray-600)', lineHeight: 1.6 }}>
            ...
            I confirm that I don't have any relevant interest of below: — I didn't work with the applied/client organization in the recent two years. — I and Q4A didn't supply any consulting, training and internal audit for the applied/client organization in the recent two years.
          </div>
