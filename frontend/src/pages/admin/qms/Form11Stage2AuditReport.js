...
const SURV_CHECKS = [
  ...
  'Compliance of use of Q4A logo/marks & Applicable AB logo / marks, if applicable',
                ...
                <tbody>
                  <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
                    <td style={{ padding: '10px 12px', fontSize: 13, borderRight: '1px solid #e2e8f0', minWidth: 320 }}>
                      I carried out this audit as above and submit this report to Q4A report reviewer. I hereby submit the audit report of the organization and my recommendation for:
                    </td>
