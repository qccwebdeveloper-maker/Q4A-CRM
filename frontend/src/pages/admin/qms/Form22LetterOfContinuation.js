...
const DEFAULT = {
  ...
  signatoryOrg: 'Q4A Management Private Limited',
};
    ...
    >
      {({ data, set, clientInfo }) => (
        <div>
          ...
          <FormRow cols={3}>
            <FormField label="Certificate No."><FInput value={data.certificateNo} onChange={v => set('certificateNo', v)} placeholder="Q4A/..." /></FormField>
          ...
          <FormRow cols={2}>
            ...
            <FormField label="Issuing Organization"><FInput value={data.signatoryOrg} onChange={v => set('signatoryOrg', v)} placeholder="Q4A Management Private Limited" /></FormField>
          </FormRow>
        </div>
      )}
    </QMSFormPage>
