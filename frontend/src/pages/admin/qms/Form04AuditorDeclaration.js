    ...
    <div>
      ...
      <div style={{ background: '#f8fafc', borderRadius: 8, border: '1px solid #e2e8f0', padding: '16px 18px', marginBottom: 20, fontSize: 13, color: '#374151', lineHeight: 1.7 }}>
        ...
        <ul style={{ marginLeft: 20, marginTop: 4 }}>
          ...
          <li>I and Q4A didn't supply any consulting, training and internal audit for the applied / client organization in recent two years.</li>
        </ul>
        <p>• I will act in accordance with Q4A policy & procedures and won't reveal any secret information without approval of Q4A and interested parties, conduct activities in accurate and impartial manner.</p>
