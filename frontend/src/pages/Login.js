        ...
        <div style={S.card}>
          ...
          <div style={S.logoWrap}>
            <div style={S.logoIcon}>
              <img src="/QC.png" alt="Q4A Management"
                style={{ width: 56, height: 56, objectFit: 'contain' }}
                onError={e => { e.target.style.display = 'none'; e.target.parentNode.innerHTML = '<span style="color:#1565c0;font-size:18px;font-weight:900">Q4A</span>'; }} />
            </div>
            <h1 style={S.h1}>Q4A CRM</h1>
