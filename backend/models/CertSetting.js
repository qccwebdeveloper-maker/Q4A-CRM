...
const certSettingSchema = new mongoose.Schema({
  ...
  authority:     { type: String, default: 'Q4A Management Private Limited' },
  validityYears: { type: Number, default: 3 },
  footerText:    { type: String, default: 'This certificate remains the property of Q4A Management Private Limited.' },
