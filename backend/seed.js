...
async function seed() {
  ...
  const users = await User.insertMany([
    // ── Admin
    {
      ...
      role: 'admin', company: 'Q4A Management Private Limited', phone: '9000000001',
  ...
  const apps = await Application.insertMany([
    ...
    },
    {
      ...
      feedbacks: [
        { from: u['ravi@greenenergy.com']._id, role: 'client', message: 'Excellent service! The audit team was professional and thorough. Highly recommend Q4A.', rating: 5, createdAt: new Date('2024-11-16') },
      ],
  ...
  const certs = await Certificate.insertMany([
    {
      ...
      iafCode: '39', accreditation: 'NABCB', certNumber: 'Q4A-EMS-2024-001',
    ...
    },
    {
      ...
      iafCode: '17', accreditation: 'NABCB', certNumber: 'Q4A-QMS-2023-088',
    ...
    },
    {
      ...
      auditorName: 'Ramesh Verma', auditorRole: 'Lead Auditor',
      iafCode: '33', accreditation: 'UKAS', certNumber: 'Q4A-ISMS-2024-012',
    ...
    
    {
      ...
      iafCode: '33', accreditation: 'NABCB', certNumber: 'Q4A-QMS-2024-056',
    ...
    },
    {
      ...
      auditorName: 'Sarah Auditor', auditorRole: 'Lead Auditor',
      iafCode: '30', accreditation: 'NABCB', certNumber: 'Q4A-QMS-2022-034',
  ...
  await CertSetting.create({
    ...
    authority: 'Q4A Management Private Limited (Q4A)',
    validityYears: 3,
    footerText: '"Q4A Management Private Limited (Q4A)" accredited by the respective accreditation body. This certificate remains the property of Q4A to whom it must be returned on request.',
    accreditation: 'NABCB',
  });
